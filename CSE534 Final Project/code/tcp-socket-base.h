...
public:
  ...
  TracedValue<uint32_t>  m_rcvWnd;         //!< Recevie Window Size, newly add
  /**
...
public:
  ...
  TracedCallback<uint32_t, uint32_t> m_rWndTrace;
  ...
  void UpdateRcvWindow(uint32_t oldValue, uint32_t newValue);
